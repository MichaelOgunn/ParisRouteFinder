...
public class ParisBenchmark {
    public int[] data;
    ParisMap parisMap = new ParisMap(35, new WritableImage(1000,1000));
    ...
    public void dijkstraBenchmark(){
        MainController.mainController.parisGraph.dijkstraShortestPath("Louvre", "Notre Dam");
    }
    ...
    public void culturalDijkstra(){
        MainController.mainController.parisGraph.dijkstraShortestPathCultural("Notre Dam", "Louvre", 10);
    }
